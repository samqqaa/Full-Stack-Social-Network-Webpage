        ...
        <nav className="navbar navbar-inverse">
            <div className="container-fluid">
                ...
                <ul className="nav navbar-nav navbar-right">
                    <li><a id='profileBtn'href="#" onClick={()=>dispatch({ type: "goToProfilePage"}) }><span className="glyphicon glyphicon-user"></span> My Profile</a></li>
                    <li><a id='logoutNav'href="#" onClick={()=>dispatch(userLogout())}><span className="glyphicon glyphicon-user"></span> Logout</a></li>
                </ul>
                </div>
            </div>
        </nav>
