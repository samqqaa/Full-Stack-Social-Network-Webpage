...
const validate = (profile)=>{
    ...
    // var newProfile={
    //         displayName: inputName == '' ?  self.state.profile.username: inputName,
    //         emailAddress: inputEmail == '' ?  self.state.profile.email: inputEmail,
    ...
    // })
    //changed here 3/16
    // console.log(self.props.profile.displayName)
