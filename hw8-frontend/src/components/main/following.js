...
const SingleUser = ({name, headline, avatar, dispatch}) => (
    <div name="singleFollower" id="fl" className="followingUser">
        ...
        <div>
            <button id='unfollowBtn' type='button' className='btn btn-info btn-sm' onClick={() => {dispatch(fetchFollowers('DELETE', name))}}>Unfollow</button> 
        </div>
    </div>
)
    ...
    return(
        <div className='content following'>
            ...
            <div className="input-group">
                ...
                <button id='followingBtn'type='button' className='btn btn-info btn-sm' onClick={() => addFollowing(followers.dispatch)}> Add Followers</button>
            </div>
            <div>
                {followers.error}
            </div>
