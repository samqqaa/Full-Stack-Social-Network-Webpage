...
plt.savefig('fig4_Lambda150.pdf')
...
accuracy = (predy == y).astype(float).sum()*100/y.shape[0]
...
plot_utils.plot_decision_boundary_sklearn_poly(X,y,sk_logreg_l2,reg,p,'Chip Test 1', 'Chip Test 2',['y = 0','y = 1'])
plt.savefig('fig4_sk_Lambda150.pdf')
...
plt.savefig('fig5_Lambda150.pdf')
