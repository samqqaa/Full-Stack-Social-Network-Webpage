...
class LogisticRegressor:
    ...
    def loss(self, *args):
        ...
        h = utils.sigmoid(np.dot(theta, X.T))
        J = ((np.dot(y, np.log(h).T))+(np.dot((1-y), np.log(1-h).T)))/(-m)
        ###########################################################################
        #                           END OF YOUR CODE                              #
        ###########################################################################
        return J
    ...
    def grad_loss(self, *args):
        ...
        grad = np.dot((utils.sigmoid(theta.dot(X.T)) - y), X)/m
        ###########################################################################
        #                           END OF YOUR CODE                              #
        ###########################################################################
        return grad
    ...
    def predict(self, X):
        ...
        y_pred = (np.dot(self.theta, X.T)>=0).astype(float)
...
class RegLogisticRegressor:
    ...
    def loss(self, *args):
        ...
        ##########################################################################
        h = utils.sigmoid(np.dot(theta, X.T))
        J = ((np.dot(y, np.log(h).T))+(np.dot((1-y), np.log(1-h).T)))/(-m) + np.dot(theta[1:].T, theta[1:])*reg/(2*m)
    ...
    def grad_loss(self, *args):
        ...
        # TODO: 1 line of code expected                                          #
        ##########################################################################
        grad = np.dot((utils.sigmoid(theta.dot(X.T)) - y), X)/m + np.append(0, theta[1:]*reg/m)
