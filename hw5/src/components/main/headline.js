    ...
    return(
        <div className='content headline'>
            ...
            <div className="form-group">
                ...
                <button type="button" className="btn btn-default" onClick={() => updateHeadline(profile.dispatch,profile)}>Update</button>
            </div>
        </div>
    )
}
...
const updateHeadline = (dispatch, profile) => {
    const newHeadline = document.getElementById('exampleInputName').value
    if(newHeadline) {
